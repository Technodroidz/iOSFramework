...
#ifndef SURVAYNEW_SWIFT_H
#define SURVAYNEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SurvayNew",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// \endcodeShows: ★★★★☆ (123)
IB_DESIGNABLE
SWIFT_CLASS("_TtC9SurvayNew10CosmosView")
...
SWIFT_CLASS("_TtC9SurvayNew11EmojiRateVC")
@interface EmojiRateVC : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9SurvayNew10LongtextVC")
@interface LongtextVC : UIViewController <UITextViewDelegate>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9SurvayNew16MultiselectionVC")
@interface MultiselectionVC : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MultiselectionVC (SWIFT_EXTENSION(SurvayNew)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC9SurvayNew12NewFeatureVC")
...
SWIFT_CLASS("_TtC9SurvayNew10OneTwoFive")
@interface OneTwoFive : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9SurvayNew12ReviewRateVC")
@interface ReviewRateVC : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ReviewRateVC (SWIFT_EXTENSION(SurvayNew)) <UICollectionViewDataSource, UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC9SurvayNew11SingleAnsVC")
@interface SingleAnsVC : UIViewController <UITableViewDataSource, UITableViewDelegate>
- (void)viewDidLoad;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC9SurvayNew8ThankuVC")
@interface ThankuVC : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9SurvayNew10WellcomeVC")
